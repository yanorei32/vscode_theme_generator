...
impl WorkbenchColorCustomizations {
    pub fn new(palette: &WrapFullPalette, no_saturation_fg: bool) -> Self {
        ...
        Self {
            ...
            editor_fold_background: palette.bg[4],
            ...
            editor_find_match_highlight_background: palette.bg[0],
            editor_linked_editing_background: palette.bg[4],
            editor_inactive_selection_background: palette.bg[4],
            editor_selection_background: palette.bg[4],
            editor_selection_highlight_background: palette.bg[4],
            editor_selection_highlight_border: palette.gray[0],
            editor_word_highlight_background: palette.bg[4],
            editor_word_highlight_strong_background: palette.bg[4],
