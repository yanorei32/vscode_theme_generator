...
impl WorkbenchColorCustomizations {
    pub fn new(palette: &WrapFullPalette, no_saturation_fg: bool) -> Self {
        let fg = if no_saturation_fg {
            ...
            &palette.color_table[PaletteColor::Gray]
        };
        Self {
            focus_border: palette.color_table[PaletteColor::Blue][2],
            foreground: fg[3],
            description_foreground: palette.color_table[PaletteColor::Gray][2],
            error_foreground: palette.color_table[PaletteColor::Red][3],

            text_link_foreground: palette.color_table[PaletteColor::Blue][3],
            text_link_active_foreground: palette.color_table[PaletteColor::Blue][3],
            text_block_quote_background: palette.color_table[PaletteColor::Bg][0],
            text_block_quote_border: palette.color_table[PaletteColor::Gray][1],
            text_code_block_background: palette.color_table[PaletteColor::Bg][0],
            text_preformat_foreground: palette.color_table[PaletteColor::Gray][3],
            text_separator_foreground: palette.color_table[PaletteColor::Gray][1],

            button_background: palette.color_table[PaletteColor::Bg][0],
            button_foreground: fg[4],
            button_hover_background: palette.color_table[PaletteColor::Bg][1],

            button_secondary_background: palette.color_table[PaletteColor::Bg][1],
            button_secondary_foreground: fg[3],
            button_secondary_hover_background: palette.color_table[PaletteColor::Bg][2],

            checkbox_background: palette.color_table[PaletteColor::Bg][1],
            checkbox_border: palette.color_table[PaletteColor::Gray][3],

            dropdown_background: palette.color_table[PaletteColor::Bg][1],
            dropdown_border: palette.color_table[PaletteColor::Gray][3],
            dropdown_foreground: fg[3],
            dropdown_list_background: palette.color_table[PaletteColor::Bg][0],

            input_background: palette.color_table[PaletteColor::Bg][1],
            input_border: palette.color_table[PaletteColor::Gray][3],
            input_foreground: fg[3],
            input_placeholder_foreground: fg[2],

            badge_foreground: fg[3],
            badge_background: palette.color_table[PaletteColor::Bg][1],

            progress_bar_background: palette.color_table[PaletteColor::Blue][2],

            title_bar_active_foreground: fg[3],
            title_bar_active_background: palette.color_table[PaletteColor::Bg][2],
            title_bar_inactive_foreground: fg[2],
            title_bar_inactive_background: palette.color_table[PaletteColor::Bg][1],
            title_bar_border: palette.color_table[PaletteColor::Gray][3],

            activity_bar_foreground: fg[3],
            activity_bar_inactive_foreground: palette.color_table[PaletteColor::Gray][2],
            activity_bar_background: palette.color_table[PaletteColor::Bg][2],
            activity_bar_badge_foreground: fg[3],
            activity_bar_badge_background: palette.color_table[PaletteColor::Bg][2],
            activity_bar_active_border: palette.color_table[PaletteColor::Gray][2],
            activity_bar_border: palette.color_table[PaletteColor::Gray][3],

            side_bar_foreground: fg[3],
            side_bar_background: palette.color_table[PaletteColor::Bg][3],
            side_bar_border: palette.color_table[PaletteColor::Gray][0],
            side_bar_title_foreground: fg[3],
            side_bar_section_header_foreground: fg[3],
            side_bar_section_header_background: palette.color_table[PaletteColor::Bg][3],
            side_bar_section_header_border: palette.color_table[PaletteColor::Gray][3],

            list_hover_foreground: fg[3],
            list_inactive_selection_foreground: fg[3],
            list_active_selection_foreground: fg[3],
            list_hover_background: palette.color_table[PaletteColor::Bg][3],
            list_inactive_selection_background: palette.color_table[PaletteColor::Bg][2],
            list_active_selection_background: palette.color_table[PaletteColor::Bg][1],
            list_inactive_focus_background: palette.color_table[PaletteColor::Bg][0],
            list_focus_background: palette.color_table[PaletteColor::Bg][4],

            tree_indent_guides_stroke: palette.color_table[PaletteColor::Gray][1],

            notification_center_header_foreground: fg[2],
            notification_center_header_background: palette.color_table[PaletteColor::Bg][0],
            notifications_foreground: fg[2],
            notifications_background: palette.color_table[PaletteColor::Bg][2],
            notifications_border: palette.color_table[PaletteColor::Gray][3],
            notifications_error_icon_foreground: palette.color_table[PaletteColor::Red][0],
            notifications_warning_icon_foreground: palette.color_table[PaletteColor::Yellow][2],
            notifications_info_icon_foreground: palette.color_table[PaletteColor::Blue][3],

            picker_group_border: palette.color_table[PaletteColor::Gray][1],
            picker_group_foreground: fg[2],

            quick_input_background: palette.color_table[PaletteColor::Bg][0],
            quick_input_foreground: fg[2],

            status_bar_foreground: fg[2],
            status_bar_background: palette.color_table[PaletteColor::Bg][2],
            status_bar_border: palette.color_table[PaletteColor::Gray][2],
            status_bar_no_folder_background: palette.color_table[PaletteColor::Bg][0],
            status_bar_debugging_background: palette.color_table[PaletteColor::Bg][2],
            status_bar_debugging_foreground: palette.color_table[PaletteColor::Gray][2],
            status_bar_item_prominent_background: palette.color_table[PaletteColor::Gray][3],
            status_bar_item_remote_foreground: fg[3],
            status_bar_item_remote_background: palette.color_table[PaletteColor::Bg][0],

            editor_group_header_tabs_background: palette.color_table[PaletteColor::Bg][1],
            editor_group_header_tabs_border: palette.color_table[PaletteColor::Gray][2],
            editor_group_border: palette.color_table[PaletteColor::Gray][2],

            tab_active_foreground: fg[2],
            tab_inactive_foreground: fg[3],
            tab_inactive_background: palette.color_table[PaletteColor::Bg][2],
            tab_active_background: palette.color_table[PaletteColor::Bg][4],
            tab_hover_background: palette.color_table[PaletteColor::Bg][3],
            tab_unfocused_hover_background: palette.color_table[PaletteColor::Bg][4],
            tab_border: palette.color_table[PaletteColor::Gray][2],
            tab_unfocused_active_border_top: palette.color_table[PaletteColor::Gray][2],
            tab_active_border: palette.color_table[PaletteColor::Gray][0],
            tab_unfocused_active_border: palette.color_table[PaletteColor::Gray][0],
            tab_active_border_top: palette.color_table[PaletteColor::Gray][1],

            breadcrumb_foreground: fg[3],
            breadcrumb_focus_foreground: fg[2],
            breadcrumb_active_selection_foreground: palette.color_table[PaletteColor::Gray][4],
            breadcrumb_picker_background: palette.color_table[PaletteColor::Bg][2],

            editor_foreground: fg[2],
            editor_background: palette.color_table[PaletteColor::Bg][2],
            editor_widget_background: palette.color_table[PaletteColor::Bg][3],
            editor_fold_background: palette.color_table[PaletteColor::Bg][4].alpha(0.5),
            editor_line_highlight_background: palette.color_table[PaletteColor::Bg][4],
            editor_line_number_foreground: fg[1],
            editor_line_number_active_foreground: fg[2],
            editor_indent_guide_background: palette.color_table[PaletteColor::Bg][0],
            editor_indent_guide_active_background: palette.color_table[PaletteColor::Bg][1],
            editor_whitespace_foreground: fg[1],
            editor_cursor_foreground: fg[3],
            editor_error_foreground: palette.color_table[PaletteColor::Red][3],
            editor_warning_foreground: palette.color_table[PaletteColor::Yellow][3],

            editor_find_match_background: palette.color_table[PaletteColor::Bg][4],
            editor_find_match_highlight_background: palette.color_table[PaletteColor::Bg][0].alpha(0.5),
            editor_linked_editing_background: palette.color_table[PaletteColor::Bg][4],
            editor_inactive_selection_background: palette.color_table[PaletteColor::Bg][4].alpha(0.5),
            editor_selection_background: palette.color_table[PaletteColor::Bg][4],
            editor_selection_highlight_background: palette.color_table[PaletteColor::Bg][4].alpha(0.5),
            editor_selection_highlight_border: palette.color_table[PaletteColor::Gray][0],
            editor_word_highlight_background: palette.color_table[PaletteColor::Bg][4].alpha(0.5),
            editor_word_highlight_strong_background: palette.color_table[PaletteColor::Bg][4].alpha(0.5),
            editor_word_highlight_border: palette.color_table[PaletteColor::Gray][0],
            editor_word_highlight_strong_border: palette.color_table[PaletteColor::Gray][0],
            editor_bracket_match_background: palette.color_table[PaletteColor::Bg][4],
            editor_bracket_match_border: palette.color_table[PaletteColor::Gray][0],

            editor_gutter_modified_background: palette.color_table[PaletteColor::Blue][2],
            editor_gutter_added_background: palette.color_table[PaletteColor::Green][1],
            editor_gutter_deleted_background: palette.color_table[PaletteColor::Red][2],
            ...
            scrollbar_shadow: palette.color_table[PaletteColor::Bg][4],
            scrollbar_slider_background: palette.color_table[PaletteColor::Bg][2],
            scrollbar_slider_hover_background: palette.color_table[PaletteColor::Bg][1],
            scrollbar_slider_active_background: palette.color_table[PaletteColor::Bg][0],
            editor_overview_ruler_border: palette.color_table[PaletteColor::Gray][2],

            panel_background: palette.color_table[PaletteColor::Bg][2],
            panel_border: palette.color_table[PaletteColor::Gray][2],
            panel_title_active_border: palette.color_table[PaletteColor::Gray][0],
            panel_title_active_foreground: palette.color_table[PaletteColor::Gray][0],
            panel_title_inactive_foreground: palette.color_table[PaletteColor::Gray][4],
            panel_input_border: palette.color_table[PaletteColor::Gray][0],

            terminal_foreground: fg[3],
            terminal_tab_active_border: palette.color_table[PaletteColor::Gray][4],
            terminal_cursor_background: palette.color_table[PaletteColor::Bg][2],
            terminal_cursor_foreground: palette.color_table[PaletteColor::Gray][2],

            terminal_ansi_bright_white: fg[4],
            terminal_ansi_white: fg[4],
            terminal_ansi_bright_black: fg[0],
            terminal_ansi_black: fg[0],
            terminal_ansi_blue: palette.color_table[PaletteColor::Blue][2],
            terminal_ansi_bright_blue: palette.color_table[PaletteColor::Blue][2],
            terminal_ansi_green: palette.color_table[PaletteColor::Green][2],
            terminal_ansi_bright_green: palette.color_table[PaletteColor::Green][2],
            terminal_ansi_cyan: palette.color_table[PaletteColor::Blue][2],
            terminal_ansi_bright_cyan: palette.color_table[PaletteColor::Blue][2],
            terminal_ansi_red: palette.color_table[PaletteColor::Red][2],
            terminal_ansi_bright_red: palette.color_table[PaletteColor::Red][2],
            terminal_ansi_magenta: palette.color_table[PaletteColor::Purple][2],
            terminal_ansi_bright_magenta: palette.color_table[PaletteColor::Purple][2],
            terminal_ansi_yellow: palette.color_table[PaletteColor::Yellow][2],
            terminal_ansi_bright_yellow: palette.color_table[PaletteColor::Yellow][2],

            editor_bracket_highlight_foreground1: palette.color_table[PaletteColor::Blue][3],
            editor_bracket_highlight_foreground2: palette.color_table[PaletteColor::Orange][3],
            editor_bracket_highlight_foreground3: palette.color_table[PaletteColor::Purple][3],
            editor_bracket_highlight_foreground4: palette.color_table[PaletteColor::Blue][3],
            editor_bracket_highlight_foreground5: palette.color_table[PaletteColor::Orange][3],
            editor_bracket_highlight_foreground6: palette.color_table[PaletteColor::Purple][3],

            debug_tool_bar_background: palette.color_table[PaletteColor::Bg][2],
            editor_stack_frame_highlight_background: palette.color_table[PaletteColor::Bg][3],
            editor_focused_stack_frame_highlight_background: palette.color_table[PaletteColor::Bg][3],

            peek_view_editor_match_highlight_background: palette.color_table[PaletteColor::Bg][3],
            peek_view_result_match_highlight_background: palette.color_table[PaletteColor::Bg][4],
            peek_view_editor_background: palette.color_table[PaletteColor::Bg][0],
            peek_view_result_background: palette.color_table[PaletteColor::Bg][1],

            settings_header_foreground: fg[2],
            settings_modified_item_indicator: palette.color_table[PaletteColor::Blue][2],
            welcome_page_button_background: palette.color_table[PaletteColor::Bg][0],
            welcome_page_button_hover_background: palette.color_table[PaletteColor::Bg][1],
        }
    }
}
