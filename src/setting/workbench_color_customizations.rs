...
use crate::{
    color::{Color, HexStr, ReplaceAlphaExt},
...
impl WorkbenchColorCustomizations {
    pub fn new(palette: &WrapFullPalette, no_saturation_fg: bool) -> Self {
        ...
        Self {
            ...
            editor_find_match_highlight_background: palette.color_table[Color::Bg][0].alpha(0.5),
            editor_linked_editing_background: palette.color_table[Color::Bg][4],
            editor_inactive_selection_background: palette.color_table[Color::Bg][4].alpha(0.5),
            editor_selection_background: palette.color_table[Color::Bg][4],
            editor_selection_highlight_background: palette.color_table[Color::Bg][4].alpha(0.5),
            ...
            editor_word_highlight_strong_background: palette.color_table[Color::Bg][4].alpha(0.5),
            ...
            editor_focused_stack_frame_highlight_background: palette.color_table[Color::Bg][3],
